...
[data-testid="stFileUploader"] {
    background: #1e2130 !important;
    border: 2px dashed #2d3348 !important;
    border-radius: 12px !important;
}
[data-testid="stFileUploader"] * {
    color: #94a3b8 !important;
...
if page == "Analytics Dashboard":
    ...
    if file:
        ...
        DARK_PLOT = dict(
            ...
            xaxis=dict(gridcolor="#2d3348", linecolor="#2d3348", showgrid=False, tickfont=dict(color="#64748b")),
            yaxis=dict(gridcolor="#2d3348", linecolor="#2d3348", tickfont=dict(color="#64748b")),
            hoverlabel=dict(bgcolor="#1e2130", font_size=12, bordercolor="#2d3348", font_color="#e2e8f0"),
        )
        ...
        fig.update_layout(**DARK_PLOT, showlegend=False, title_font=dict(color="#f1f5f9", size=13))
        ...
        fig2 = px.box(filtered_df, x="Prediction", y="MonthlyIncome", color="Prediction",
            title="Income Impact",
            color_discrete_map={"Attrition": "#f87171", "No Attrition": "#34d399"})
        fig2.update_layout(**DARK_PLOT, showlegend=False, title_font=dict(color="#f1f5f9", size=13))
        ...
        fig3.update_layout(**DARK_PLOT, title_font=dict(color="#f1f5f9", size=13),
        ...
        fig4 = px.pie(filtered_df, names="Prediction", title="Risk Breakdown",
            color_discrete_map={"Attrition": "#f87171", "No Attrition": "#34d399"})
        fig4.update_layout(**DARK_PLOT, title_font=dict(color="#f1f5f9", size=13),
            legend=dict(font=dict(color="#94a3b8"), bgcolor="rgba(0,0,0,0)"))
        fig4.update_traces(textfont_color="#f1f5f9")
